export const regionStoryData = [
  ...
  },
  {
    ...
    content:
      "경희대학교 국제캠퍼스라는 이름에는 서울의 본교와 떨어진 분교라는 느낌보다, 더 넓은 세계와 연결되는 대학 공간을 만들겠다는 의지가 담겨 있습니다. 용인 기흥구의 캠퍼스는 넓은 녹지와 단과대 건물, 기숙사와 체육 시설이 하나의 생활권처럼 이어집니다. 지금 이곳을 걷는다면, 이름 그대로 강의실 안의 공부와 캠퍼스 밖의 도시가 서로 말을 거는 장면을 듣고 있는 셈입니다.",
    keywords: ["경희대학교", "국제캠퍼스", "용인", "기흥구", "영통", "지명"],
  ...
  },
  {
    ...
    regionName: "경희대학교 국제캠퍼스",
    storyType: "history",
    title: "용인 끝자락에 자리 잡은 대학 도시",
    content:
      "경희대학교 국제캠퍼스는 행정구역으로는 경기도 용인시 기흥구에 있고, 생활권으로는 수원 영통과도 맞닿아 있습니다. 그래서 이곳의 하루는 조금 독특합니다. 주소는 용인인데 버스와 상권, 학생들의 약속 장소는 수원 영통과 자연스럽게 이어집니다. 캠퍼스가 도시의 경계 위에 놓이면서, 학생들은 강의실과 자취방, 카페와 정류장 사이를 오가며 자기만의 작은 지도를 만들어 갑니다.",
    keywords: ["용인", "기흥구", "영통", "경희대학교", "국제캠퍼스", "역사"],
    coordinates: { lat: 37.2414, lng: 127.0811 },
    radiusKm: 3,
    sourceType: "region_story_db",
  },
  {
    ...
    content:
      "경희대학교 국제캠퍼스 주변은 대학 생활, 주거지, 작은 상권이 맞물린 지역입니다. 아침에는 정류장에서 강의실로 향하는 발걸음이 길을 채우고, 점심에는 학식과 주변 식당이 하루의 중심이 됩니다. 오후가 지나면 도서관, 운동장, 산책로, 카페가 각자의 속도로 켜집니다. 이곳의 매력은 관광 명소처럼 한 장면으로 설명되지 않고, 학생들이 매일 반복해서 만드는 생활의 리듬 속에서 드러납니다.",
    keywords: ["경희대학교", "국제캠퍼스", "영통", "대학가", "문화"],
    coordinates: { lat: 37.2414, lng: 127.0811 },
    radiusKm: 3,
    sourceType: "region_story_db",
  },
  {
    ...
    regionName: "경희대학교 국제캠퍼스",
    storyType: "legend",
    title: "늦은 밤 캠퍼스 불빛의 작은 전설",
    content:
      "경희대 국제캠퍼스에 오래된 설화가 크게 전해지는 것은 아니지만, 대학가에는 늘 학생들이 만든 작은 전설이 생깁니다. 시험 기간 늦은 밤에도 꺼지지 않는 도서관 불빛, 과제 마감 직전에 갑자기 가까워지는 편의점, 언덕을 오르고 나서야 보이는 캠퍼스의 넓은 하늘 같은 것들입니다. 이 카드는 사실을 꾸며낸 괴담이 아니라, 이곳을 다녀간 사람들이 공감하는 생활형 전설에 가깝습니다.",
    keywords: ["경희대학교", "국제캠퍼스", "도서관", "시험기간", "설화", "대학가"],
    coordinates: { lat: 37.2414, lng: 127.0811 },
    radiusKm: 3,
    sourceType: "region_story_db",
  },
